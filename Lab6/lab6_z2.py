...
from Lab6.statistic2 import Distribution
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Проверка гипотезы о равномерном расрпеделении')
    ...
    def get_interval_row(self):
        ...
        # interval_row = {(2, 4): 90, (4, 6): 92, (6, 8): 86, (8, 10): 87, (10, 12): 91, (12, 14): 92, (14, 16): 86, (16, 18): 86, (18, 20): 89, (20, 22): 91 }
        return interval_row
    ...
    def fillLineEdits(self):
        ...
        self.line_edits[5].setText(f'{self.distribution.b}')
